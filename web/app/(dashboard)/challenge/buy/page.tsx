...
export default function BuyChallengePage() {
    ...
    const challenges = [
        { type: "2K Challenge", amount: 2000, price: 19 },
        { type: "5K Challenge", amount: 5000, price: 39 },
    ...
    const handleBuy = async (challenge: any) => {
        ...
        router.push(`/checkout?plan=${encodeURIComponent(challenge.type)}&price=${challenge.price}`);
        // Note: The checkout page handles the payment flow now.
    };
